"""
Add Call 2 to kt/seed: after themes are saved, generate key_facts + subtopic_details
for all 10 themes in a single Sonnet call, then update the DB rows.
"""
...
OLD = '            log.info(f"kt/seed: done -- {len(themes)} themes, {len(assignments)} assignments")\n'
